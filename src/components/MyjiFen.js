...
export default class MyJiFen extends React.Component {
    ...
    componentWillMount() {
        ...
        fetch(GetScoreList + `?pageIndex=${this.state.current}&pageSize=${this.state.pageSize}`,
            {
                method: "GET",
                headers: {
                    'Authorization': window.localStorage.getItem('Tonken')
    ...
    onChange = (page) => {
        fetch(GetScoreList + `?pageIndex=${page}&pageSize=${this.state.pageSize}`,
            {
                method: "GET",
                headers: {
                    'Authorization': window.localStorage.getItem('Tonken')
