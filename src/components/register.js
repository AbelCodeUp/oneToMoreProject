...
export default class Register extends React.Component {
    ...
    handleSubmit = (e) => {//提交表单
        ...
        fetch(UserRegister+"?Phone=" + form.Phone.value + "&OpenId=" + OpenId + "&Code=" + form.Code.value + "&Password=" + form.Pwd.value,
            {
                method: "GET"
            })
            .then(res => res.json())
    ...
    handleSendCode = (e) => {
        e.preventDefault();
        fetch(SendPhoneCode+"?Phone=" + this.state.form.Phone.value,
            {
                method: "GET"
            })
            .then(res => res.json())
