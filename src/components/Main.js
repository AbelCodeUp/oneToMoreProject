...
import Invitation from './Invitation'; //我的邀请函
import Duihuan from './Duihuan'; //兑换
import Xuzhi from './Xuzhi'; //须知
      ...
      <Router history={hashHistory}>
        ...
        <Route path="/Main" component={Index}>
          ...
          <Route path="/Main/Person" component={PersonCenter} >
            ...
            <Route path="/Main/Person/Invitation" component={Invitation} />
          ...
          <Route path="/Main/Index" component={StudyCenter}>
            ...
            <Route path="/Main/Index/Duihuan" component={Duihuan} /> 
          </Route>
          <Route path="/Main/Xuzhi" component={Xuzhi} />
        </Route>
