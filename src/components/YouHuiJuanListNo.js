...
export default class youhuijuan extends Component {
    ...
    xiangClick(v) {
        fetch(GetCouponDetails+`?CouponId=${v}`,//未使用
        {
            method: "GET",
    ...
    render() {
        ...
        if (noArr.length == 0 || noArr == null) {
            items.push(
                <div className="youhui_block" style={{ width: '100%' }}>
            ...
            noArr.map((d, i) => {
                ...
                items.push(
                    <div className="youhui_block" key={i} onClick={this.xiangClick.bind(this,d.CouponId)}>
