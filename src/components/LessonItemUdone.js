...
export default class LessonItemUdone extends Component {
    ...
    componentDidMount() {
        fetch(GetSystemTime,
            ...
            .then(json => {
                ...
                fetch(ClassBookDetails+`?BdeId=${ret.uid}&BookingId=${ret.bid}`,//获取课程详情
                    {
                        method: "GET",
                        headers: {
    ...
    yuyueClick() {//预约
        ...
        fetch(GetTch_Lesson+`?LessonTime=${this.state.days}`,
            {
                method: "GET",
                mode: "cors",
                headers: {
    ...
    yekeSucClick() {//预约确定
        ...
        fetch(ReserveLessonRoom+`?BookingId=${ret.bid}&BDEId=${ret.uid}&LessonTime=${this.state.days + ' ' + this.state.time}`,//预约课程
            {
                method: "GET",
                mode: "cors",
                headers: {
    ...
    handleClickO(v1, v2, v3) {//根据日期获取时间
        ...
        fetch(GetTch_Lesson+`?LessonTime=${v1}`,
            {
                method: "GET",
                mode: "cors",
                headers: {
