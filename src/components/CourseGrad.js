...
export default class DeviceTesting extends Component {
    ...
    render() {
        ...
        return (
            <div>
                < div className="testTing" id="testDate" style={isShowz} >
                        ...
                        <div className="perfectInfor" style={{ marginTop: '70px' }}>
                            ...
                            <ul>
                                ...
                                <li className={userDateClass}>
                                    ...
                                    <div className="sexbox" style={{position:'relative'}} id="datebox" ref="calPack">
                                        <DatePicker getCalendarContainer={() => document.querySelector('#testDate')} onChange={this.onChange.bind(this)} />
                                    </div>
                                </li>
                                <li>
                                    <span>性别</span>
