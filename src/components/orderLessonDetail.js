...
export default class OrderLessonDetail extends Component {
    ...
    handleClickO(v1, v2, v3) {//切换日期
        ...
        fetch(GetLessonRoom+`?LessonTime=${this.state.dateArr[v3].time}&BDEId=${ret.uid}&BookingId=${ret.bid}`,
            {
                method: "GET",
                headers: {
    ...
    componentWillMount() {
        fetch(GetSystemTime,
            ...
            .then(json => {
                ...
                fetch(GetLessonRoom+`?LessonTime=${dataArrs[0].time}&BDEId=${ret.uid}&BookingId=${ret.bid}`,
                    {
                        method: "GET",
                        headers: {
                            'Authorization': window.localStorage.getItem('Tonken')
                ...
                fetch(ClassBookDetails+`?BdeId=${ret.uid}&bookingId=${ret.bid}`,
                    {
                        method: "GET",
                        headers: {
    ...
    yuyueSucClick() {//预约
        ...
        fetch(JoinLessonRoom+`?LessonTime=${this.state.time}&BDEId=${ret.uid}&BookingId=${ret.bid}&LessonId=${this.state.lessonId}`,
            {
                method: "GET",
                headers: {
                    'Authorization': window.localStorage.getItem('Tonken')
                ...
                <div className="order_main">
                    ...
                    <div className="yy_mengtai" ref="keshitip">
                        <div className="bnyy" style={{ display: 'block' }}>
                            ...
                            <a className="yyipt bnqx" href={CourseBuy} target="_blank" style={{ display: 'block' }}>立即购买 </a>
