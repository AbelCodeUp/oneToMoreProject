...
export default class PersonInfo extends Component {
    ...
    handleClick() {
        ...
        fetch(SendChangePwdSMS+`?cell=${this.state.haoma}`,
            {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                    , Authorization: window.localStorage.getItem('Tonken')
    ...
    handleClickS() { //发送验证码
        ...
        fetch(SendSMSCode+`?cell=${this.state.newPhone}`,
            {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                    , Authorization: window.localStorage.getItem('Tonken')
    ...
    handleBtn() {
        ...
        fetch(ExistMobilCode+`?cell=${this.state.haoma}&&code=${yzms}&&type=0`,
            {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                    , Authorization: window.localStorage.getItem('Tonken')
    ...
    handleBtnS() {
        ...
        fetch(ExistMobilCode+`?cell=${this.state.newPhone}&&code=${yzmss}&&type=1`,
            {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                    , Authorization: window.localStorage.getItem('Tonken')
