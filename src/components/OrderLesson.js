...
export default class OrderLesson extends Component {
    ...
    componentDidMount() {
        ...
        fetch(GetBookList,
            ...
            .then(json => {
                ...
                if (json.data[json.data.length - 1].BookingTitle == "A1") {
                    ...
                    this.refs.A1Father.style.display='none';
                    ...
                    this.refs.A0Father.style.display='none';
                ...
                fetch(GetUnitBookList+`?bookingid=${json.data[json.data.length - 1].BookingId}`,//获取等级1的单元信息
                    {
                        headers: {
                            'Content-Type': 'application/x-www-form-urlencoded'
                            , 'Authorization': window.localStorage.getItem('Tonken')
        ...
        fetch(GetBookOverInfo,//获取等级1的单元信息
            {
                headers: {
                    'Content-Type': 'application/x-www-form-urlencoded'
                    , 'Authorization': window.localStorage.getItem('Tonken')
    ...
    handleClick() {//第一个等级单击事件
        ...
        if (0 <= this.state.index) {
            ...
            fetch(GetBookOverInfo+`?bookingid=1`,
                {
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                        , 'Authorization': window.localStorage.getItem('Tonken')
    ...
    handleClickSecond() {//第二个等级单击事件
        if (1 <= this.state.index) {
            ...
            fetch(GetUnitBookList+'?bookingid=2',
                {
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                        , 'Authorization': window.localStorage.getItem('Tonken')
    ...
    handleClickThird() {//第三个等级单击事件
        if (2 <= this.state.index) {
            ...
            fetch(GetUnitBookList+'?bookingid=3',
                {
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                        , 'Authorization': window.localStorage.getItem('Tonken')
    ...
    handleClickFourth() {//第四个等级单击事件
        if (3 <= this.state.index) {
            ...
            fetch(GetUnitBookList+'?bookingid=4',
                {
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
                        , 'Authorization': window.localStorage.getItem('Tonken')
