            ...
            dataObj.map((d, i) => {
                ...
                if (d.IsComment == '0') {
                    ...
                    pinjia = <div className="index_ds_states">
                        <span className="red" ref="daiPinjiaBtn" key={i} onClick={this.pingjiaClick.bind(this, d.LessonId, d.TeacherId, d.TeacherName, d.TeacherImg, d.StudentId,d.TeacherGender)}><i className="iconfont" style={{ marginRight: '8px' }}>&#xe689;</i> 待评价 </span>
                    </div>
                } else {
                    if (!this.state.isA) {
                        pinjia = <div className="index_ds_states">
                    ...
                    <div className="index_ds_item" key={i}>
                        <div className="index_ds_header">
                            <div className="index_ds_time">
                                {timeStr}
                                <span className="origin" style={{ fontSize: '16px', marginLeft: '10px', color:'#f60' }}>{classState}</span>
                            </div>
                            {pinjia}
                        </div>
